...
import com.ivtogi.zoonotlogic.ui.common.ButtonWithIcon
...
fun LoginScreen(
    ...
    Column(
        ...
        ButtonWithIcon(
            ...
            loading = state.loginWithGoogleLoading,
            image = R.drawable.ic_google,
            onClick = { viewModel.loginWithGoogle() }
        )
        Spacer(modifier = Modifier.weight(1f))
        if (state.loginError){
            Toast.makeText(LocalContext.current, R.string.login_error, Toast.LENGTH_SHORT).show()
